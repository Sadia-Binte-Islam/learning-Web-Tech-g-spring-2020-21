...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form  onsubmit="return validate()" id="myform" action="../controller/sellerloginchk.php" method="post">
				<img src="../assets/image/avatar.svg">
				<h2 class="title">Welcome Seller </h2>
				...
				<div class="signup">
					<p>Don't have account!!
						<a href="sellersignup.php"> join Now </a>
				</div>
