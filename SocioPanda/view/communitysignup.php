...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form class="form" onsubmit="return validateform()" name="myform" method="post"  action="../controller/communitysignupchk.php" >
				...
				<div class="signup">
					...
					<a href="communityuserlogin.php"> Login Here </a>
				</div>
